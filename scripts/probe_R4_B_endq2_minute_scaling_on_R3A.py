"""scripts/probe_R4_B_endq2_minute_scaling_on_R3A.py -- R4-B (loop 5).
...
Usage:
    from scripts.probe_R4_B_endq2_minute_scaling_on_R3A import treatment
    from scripts.improve_loop.scaffold import run_point_probe, BASELINE
    run_point_probe("endQ2", "R4_B_endq2_minute_scaling_on_R3A", treatment)

CLI:
    python scripts/probe_R4_B_endq2_minute_scaling_on_R3A.py
    python scripts/probe_R4_B_endq2_minute_scaling_on_R3A.py --max-games 200
"""
...
def main() -> int:
    ap = argparse.ArgumentParser(
        description="R4-B: bounded minute-trajectory scaling at endQ2")
    ...
    run_point_probe(
        "endQ2",
        "R4_B_endq2_minute_scaling_on_R3A",
        treatment,
        baseline=BASELINE,

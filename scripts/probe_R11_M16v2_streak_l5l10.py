...
_CACHE_OUT = os.path.join(PROJECT_DIR, "data", "cache", "probe_R11_M16v2_streak_l5l10_results.json")

# M16v2: shorter/medium windows (L5 recent vs L10 baseline) instead of L3/L20.
# Hypothesis: PTS/REB/AST (the 3 stats M16 missed) have too much noise at L3
# for the z-score to be reliable, but L20 is too long to reflect current form.
# L5/L10 split should catch shorter-horizon trends with less noise.
_EPS = 1e-6
_L3 = 5    # "short" window — now L5
_L20 = 10  # "long" window — now L10

"""retrain_fg3m_oos_wave2b.py — Wave-2b OOS FG3M retrain with 109 features.

FG3M uses XGB-q50. Writes to data/models/oos_pre_playoffs/.
"""
...
def main() -> None:
    ...
    print(f"  Wave-2b OOS FG3M retrain (XGB-q50, cutoff < {CUTOFF_DATE})")
    ...
    stat_m = metrics.get(STAT, {}) if isinstance(metrics, dict) else {}
    val_mae = stat_m.get("val_mae") or stat_m.get("val_pinball_q50")
    print(f"  FG3M val_mae (q50 pinball): {val_mae}")

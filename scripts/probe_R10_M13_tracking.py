...
OUT_JSON   = os.path.join(DATA_CACHE, "probe_R10_M13_tracking_results.json")
...
# Tracking features to probe — 4 chosen for signal-to-noise over 7 stats.
# drv_pts and drv_count are strong for PTS/AST/FG3M/REB role-proxy.
# potential_ast discriminates playmakers (AST, PTS creation).
# cs_pts targets spot-up shooters (FG3M, PTS).
TRK_FEATURES = [
    "trk_drv_pts",
    "trk_drv_count",
